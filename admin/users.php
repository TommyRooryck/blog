                ...
                foreach ($users as $user) :
                    ...
                    <tr>
                       <td><?php echo $user->id; ?></td>
                        <td><img src="<?php echo $user->image_path_and_placeholder(); ?>" height="100" alt=""></td>
                        ...
                        <td><a href="delete_User.php?id=<?php echo $user->id; ?>" class="btn btn-danger rounded-0"><i class="fas fa-user-times"></i></a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
